...
def is_duplicate_message(message_id: str) -> bool:
    """
    Meta may deliver the same webhook event more than once.
...
def parse_incoming_webhook(payload: dict) -> Optional[dict]:
    """
    Normalizes Meta's nested webhook JSON into a flat dict.
    """
    try:
        ...
        if msg_type == "text":
            ...
            # image/video/document/sticker/contacts/unsupported etc.
